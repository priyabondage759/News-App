        ...
        <div>
            ...
            {/* <form onSubmit={handleSubmit}>
                ...
                <div className='container d-flex flex-column'>
                    <div className='main-form mb-3'>

                        <label className='label-form'>First Name :  </label>
                        <input className='input-form mx-2' value={input.fname} onChange={(e)=>setInput({...input,fname:e.target.value})} type='text' placeholder='First name Here..' />
                        ...
                        <input className='input-form mx-2' value={input.lname} onChange={(e)=>setInput({...input,lname:e.target.value})} type='text' placeholder='Last name Here..' />
                        ...
                        <div className='main-form mb-3 '>
                        <label className='label-form mx-2'>Email - ID :  </label>
                        <input className='input-form mx-2' value={input.email} 
                         onChange={(e)=>setInput({...input,email:e.target.value})}type='text' placeholder='abc@gmail.com...' />
                        ...
                        <label className='label-form mx-2'>Password :  </label>
                        <input className='input-form mx-2' value={input.pswd}
                         onChange={(e)=>setInput({...input,pswd:e.target.value})} type='password' placeholder='***' />
                        ...
                        <span><p>Already registered? <Link to='/login'>Login</Link></p></span>
                        </div>
